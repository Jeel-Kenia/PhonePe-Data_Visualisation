...
def home_page():
    ...
    phonepe_description = """Embark on an extraordinary journey into the realm of digital payments in India with PhonePe 
                             Pulse! As a frontrunner in the industry, PhonePe boasts an impressive user base of over 30 
                             crore and an astonishing 2000 crore transactions. It has revolutionized the way Indians 
                             embrace digital payments, emerging as the unrivaled leader with an astounding 46% market 
                             share in UPI transactions.
                             Now, imagine harnessing the boundless potential of PhonePe Pulse through a remarkable data 
                             analytics platform. Gain an exclusive vantage point as you delve into the ever-evolving 
                             landscape of digital transactions. Unearth hidden gems of information, unravel fascinating 
                             insights, and uncover captivating trends that shape the dynamic world of digital payments in 
                             India. Brace yourself for an immersive experience as you bring this wealth of data to life 
                             through awe-inspiring visualizations."""
